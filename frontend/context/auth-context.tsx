...
export const AuthProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const login = async (email: string, password: string, role: "freelancer" | "client") => {
    setLoading(true)
    try {
      const endpoint = role === "freelancer" ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/freelancer-api/login` : `${process.env.NEXT_PUBLIC_BACKEND_URL}/client-api/login`
  ...
  const register = async (userData: any, role: "freelancer" | "client") => {
    setLoading(true)
    try {
      const endpoint = role === "freelancer" ? `${process.env.NEXT_PUBLIC_BACKEND_URL}/freelancer-api/signup` : `${process.env.NEXT_PUBLIC_BACKEND_URL}/client-api/signin`
