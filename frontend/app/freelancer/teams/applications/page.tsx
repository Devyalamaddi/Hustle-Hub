...
export default function TeamApplicationsPage() {
  ...
  const fetchTeamApplications = async () => {
    try {
      setLoading(true)
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/freelancer-api/team-applications`, {
        headers: {
  ...
  const withdrawApplication = async (applicationId: string) => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/freelancer-api/team-applications/${applicationId}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${token}`,
        },
