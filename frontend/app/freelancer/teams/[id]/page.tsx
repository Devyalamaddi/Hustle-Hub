...
export default function TeamDetailPage() {
  ...
  const fetchTeam = async () => {
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/freelancer-api/teams/${id}`, {
        headers: {
  ...
  const sendInvitation = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/freelancer-api/teams/${id}/invite/${selectedFreelancer._id}`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const removeMember = async () => {
    ...
    setIsProcessing(true)
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/freelancer-api/teams/${id}/remove/${selectedMember._id}`, {
        method: "POST",
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const updateMemberRole = async () => {
    ...
    setIsProcessing(true)
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_BACKEND_URL}/freelancer-api/teams/${id}/members/${selectedMember._id}/role`, {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`,
